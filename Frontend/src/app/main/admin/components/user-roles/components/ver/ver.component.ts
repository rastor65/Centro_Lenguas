...
export class VerComponent implements OnInit {
  ...
  onUsuarioSelect(event: any) {
    console.log("Usuario seleccionado:", event); // Verificar la estructura de datos del usuario seleccionado
  ...
  asignarRol() {
    ...
    if (existingUserRole) {
      ...
      console.log("Solicitud enviada:", bodyString);
  ...
  actualizarUserRole(userRoleId: number, updatedUserRole: UserRole) {
    ...
    console.log("Solicitud de actualización enviada:", bodyString);
  ...
  deleteUserRole(rol: any) {
    ...
    this.usuariosService.deleteUserRole(userRoleId).subscribe(
      () => {
        console.log('El user_roles se eliminó correctamente.');
